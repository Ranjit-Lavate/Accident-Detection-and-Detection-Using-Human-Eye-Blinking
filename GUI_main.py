...
root.title("Eye Blinking and Accident Detection System ")
...
#
label_l1 = tk.Label(root, text="Eye Blinking and Accident Detection System",font=("Times New Roman", 35, 'bold'),
