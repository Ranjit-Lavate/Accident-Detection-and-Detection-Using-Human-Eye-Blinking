...
img = Image.open("DrowsyDriving_Dashboard.jpg")
img =img.resize((w,h))
...
#         "language":"english",
#         "route":"p",
#         "numbers":"7887865466,7972786533,7038337242"
#     }
...
def Drowsiness():
    ...
    path = "C:/Users/ABHIJIT/Downloads/23SS236 100% code Accident detection+ Eye blink/Accident detection+Drawsiness detection/classifiers/haar-face.xml"
    ...
    face = cv2.CascadeClassifier('C:/Users/ABHIJIT/Downloads/23SS236 100% code Accident detection+ Eye blink/Accident detection+Drawsiness detection/haar cascade files/haarcascade_frontalface_alt.xml')
    leye = cv2.CascadeClassifier('C:/Users/ABHIJIT/Downloads/23SS236 100% code Accident detection+ Eye blink/Accident detection+Drawsiness detection/haar cascade files/haarcascade_lefteye_2splits.xml')
    reye = cv2.CascadeClassifier('C:/Users/ABHIJIT/Downloads/23SS236 100% code Accident detection+ Eye blink/Accident detection+Drawsiness detection/haar cascade files/haarcascade_righteye_2splits.xml')



    lbl=['Close','Open']

    model = load_model('C:/Users/ABHIJIT/Downloads/23SS236 100% code Accident detection+ Eye blink/Accident detection+Drawsiness detection/models/cnnCat2.h5')
    path = os.getcwd()
    ...
    while(True):
        ...
        for (x,y,w,h) in right_eye:
            ...
            #rpred = model.predict_classess(r_eye,axis=1)
        ...
        for (x,y,w,h) in left_eye:
            ...
            #lpred = model.predict_classes(l_eye,axis=1)
...
button1 = tk.Button(root,text="Eye Blink Detection",width=15,height=2,font=("Times new roman", 14, "bold"),bg="white",fg="black", command= Drowsiness)
button1.place(x=100 , y=100)

button3 = tk.Button(root,text="Accident Detection",width=15,height=2,font=("Times new roman", 14, "bold"),bg="white",fg="black", command= accident)
button3.place(x=100 , y=200)

button2 =tk.Button(root,text="Exit",width=15,height=2,font=("Times new roman", 14, "bold"),bg="white",fg="black",command= Exit)
